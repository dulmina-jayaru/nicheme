...
import { CreditCard, LayoutDashboard, BarChart, User, Settings } from "lucide-react";
...
<aside className="fixed md:flex flex-col w-56 bg-white/80 dark:bg-zinc-900/80 border-r border-zinc-200 dark:border-zinc-800 p-6 gap-4 shadow-lg h-screen">
        <div className="mb-8 text-2xl font-extrabold tracking-tight flex items-center gap-2">
          <CreditCard className="text-indigo-500" /> Credits
        </div>
...
<main className="flex-1 ml-56 p-8">
        <SignedIn>
          <div className="paper-texture rounded-2xl shadow-2xl p-10 max-w-full w-full text-center bg-white/90 dark:bg-zinc-900/90 border border-zinc-100 dark:border-zinc-800">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">Your credits and subscription details will appear here soon.</p>
             {/* Placeholder content */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/80 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 rounded-xl p-4 shadow">
                ...
                <p className="text-gray-500 dark:text-gray-400">Your current credit balance is displayed here.</p>
              </div>
              <div className="bg-white/80 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 rounded-xl p-4 shadow">
                <h2 className="text-xl font-semibold mb-2">Subscription Plan</h2>
                <p className="text-gray-500 dark:text-gray-400">View and manage your subscription plan.</p>
              </div>
            </div>
          </div>
        </SignedIn>
